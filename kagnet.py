...
def main():
    ...
    # datasets
    parser.add_argument('--train_graphs', default='./data/csqa/graph/train.graph.adj.demo.jsonl')
    parser.add_argument('--train_paths', default='./data/csqa/paths/train.paths.adj.demo.jsonl')
    parser.add_argument('--dev_graphs', default='./data/csqa/graph/dev.graph.adj.demo.jsonl')
    parser.add_argument('--dev_paths', default='./data/csqa/paths/dev.paths.adj.demo.jsonl')
    parser.add_argument('--test_graphs', default='./data/csqa/graph/test.graph.adj.demo.jsonl')
    parser.add_argument('--test_paths', default='./data/csqa/paths/test.paths.adj.demo.jsonl')
...
def train(args):
    ...
    dic = {'tzw': 0, 'transe': 1, 'numberbatch': 2}
    ...
    try:
        ...
        dataset = KagNetDataLoader(args.train_statements,
                                   args.train_paths,
                                   args.train_graphs,
                                   args.dev_statements,
                                   args.dev_paths,
